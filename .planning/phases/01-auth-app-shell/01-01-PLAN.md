...
Verify required keys exist in pl.json: `grep -E "(\"nav\"|\"auth\"|\"errors\"|\"loading\")" lib/i18n/dictionaries/pl.json`
Verify required keys exist in en.json: `grep -E "(\"nav\"|\"auth\"|\"errors\"|\"loading\")" lib/i18n/dictionaries/en.json`
</verify>
<done>
