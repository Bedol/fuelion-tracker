...
<task type="auto">
  <name>Update Layout.tsx to use new navigation</name>
  <files>
    components/Layout.tsx
  </files>
  <action>
...
**Note:** pages/\_app.tsx requires no changes - Layout is already wrapping Component there. The updated Layout.tsx will handle switching between authenticated and public layouts.
...
Verify \_app.tsx was not modified: `git diff pages/_app.tsx` (should show no changes from this task)
